/*The purpouse of this autonomous mode is to go straight, as to clear as many blocks
 ...
 waiting 10 seconds starting from the close RED postition*/
...
public class AutonomousRedCloseStraightFloorGoalWait extends OpMode {
    ...
    public AutonomousRedCloseStraightFloorGoalWait() {
    }
    ...
    public void loop() {
        ...
        if (currentTime > 11 && !Treadleft.isBusy() && !Treadright.isBusy()){
            ...
            Treadleft.setTargetPosition(currentLeftEncoderPosition + 1252);
            Treadright.setTargetPosition(currentRightEncoderPosition - 1137);
            Treadleft.setMode(DcMotorController.RunMode.RUN_TO_POSITION);
            Treadright.setMode(DcMotorController.RunMode.RUN_TO_POSITION);
