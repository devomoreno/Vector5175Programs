...
public class AutonomousTrial2 extends OpMode {
    //name Dcmotors and for purpose of the program
    //ex:  Dcmotor Greg
    DcMotor Treadleft;
    DcMotor Treadright;

    public AutonomousTrial2(){}
    ...
    @Override
        ...
        while((System.currentTimeMillis()-startTime)>13000 && (System.currentTimeMillis()-startTime)<20000){
            Treadleft.setPower(-.5);
            Treadright.setPower(.5);
        }
       while ((System.currentTimeMillis()-startTime)>20001 && (System.currentTimeMillis()-startTime)<30000){
           Treadleft.setPower(.5);
           Treadright.setPower(-.5);
       }
